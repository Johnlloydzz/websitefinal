...
function ProductCard({ name, shortDesc, price, desc, image, onCardClick, customWidth }) { 
  return (
    <div
      className="bg-white rounded-xl overflow-hidden shadow-lg cursor-pointer hover:brightness-110 active:brightness-75 transition-all select-none relative h-[360px] bg-[#765346]"
